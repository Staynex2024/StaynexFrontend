...
export const signUpPartner = (data: any) => {
    return (dispatch: any) =>
        new Promise((resolve, reject) => {
            apiCallPost(APIURL.CREATE_PARTNER, data, {}, false, true)
                .then(async (result: any) => {
                    let data: any = result
                    data.token = result.token
                    await dispatch(token(data.token))
...
export const fogotPassword = (data: any) => {
    return (dispatch: any) =>
        new Promise((resolve, reject) => {
            apiCallPost(APIURL.FORGOT_PASSWORD, data, {}, false, true)
                .then(async (result: any) => {
                    let data: any = result
                    data.token = result.token
                    await dispatch(token(data.token))
...
export const resetPassword = (data: any) => {
    return (dispatch: any) =>
        new Promise((resolve, reject) => {
            apiCallPost(APIURL.RESET_PASSWORD, data, {}, false, true)
                .then(async (result: any) => {
                    let data: any = result
                    data.token = result.token
                    await dispatch(token(data.token))
