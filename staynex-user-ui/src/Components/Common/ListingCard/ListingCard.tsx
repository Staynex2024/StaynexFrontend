...
const ListingCard = ({ data }: any) => {
  ...
  const handlePrice = (data : any) => {
    let minPrice= Math.min.apply(Math, listOnly(data, 'price'))
    let convertedPrice = handleConversion(conversionRate, minPrice)
                ...
                <Col xs={12} lg={7} className="ps-lg-0 d-flex">
                  <div className="Card_hotel_Box_content w-100">
                    <div className="Card_content_heading">
                      ...
                      {State && (
                        <h6>{`${State.getStateByCodeAndCountry(
                          data?.location?.state,
                    ...
                    <h6>
                      ...
                      {data?.passes.length > 0
                        ?
                        `${handlePrice(data?.passes) + " " + currencySymbol}`
                        : ''}
                    </h6>
                    <hr />
