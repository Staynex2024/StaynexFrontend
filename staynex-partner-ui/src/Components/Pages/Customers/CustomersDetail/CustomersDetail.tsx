...
import { CopyIcon, EditIcon } from '../../../../Assets/Images/svgImgs/svgImgs'
...
const CustomersDetail = () => {
    ...
    const tabledata = [
        { no: '1', name: 'SP30', nightred: '23', totalnight: '120', perks1: '5% off on restaurant F&B', perks2: '5% off on villa resort services', perks3: 'Free shuttle to and from airport' },
        { no: '1', name: 'SP30', nightred: '23', totalnight: '120', perks1: '5% off on restaurant F&B', perks2: '5% off on villa resort services', perks3: 'Free shuttle to and from airport' },
        { no: '1', name: 'SP30', nightred: '23', totalnight: '120', perks1: '5% off on restaurant F&B', perks2: '5% off on villa resort services', perks3: 'Free shuttle to and from airport' },
        { no: '1', name: 'SP30', nightred: '23', totalnight: '120', perks1: '5% off on restaurant F&B', perks2: '5% off on villa resort services', perks3: 'Free shuttle to and from airport' },
        { no: '1', name: 'SP30', nightred: '23', totalnight: '120', perks1: '5% off on restaurant F&B', perks2: '5% off on villa resort services', perks3: 'Free shuttle to and from airport' },
    ...
    return (
        <>
            <div className='Booking_Detail Customers_Detail'>
                <Link className='mb-4' to="/auth/customers"><u>Back to previous page</u></Link>
                    ...
                    <Row className='mt-5'>
                        <Col xs={12}>
                            <Nav variant="pills" className="Border_Tabs">
                                <Nav.Item><Nav.Link eventKey="personalinfo">Personal Info</Nav.Link></Nav.Item>
                                <Nav.Item><Nav.Link eventKey="passes">Passes Owned</Nav.Link></Nav.Item>
                                ...
                                >
                                    {tabledata.map((item) => (
                                        <tr>
                                            ...
                                            <td>{item.no}</td>
                                            <td><div className='copy_icon'>{item.name}</div></td>
                                            <td>{item.nightred}</td>
