...
import * as ClearIcon from '@mui/icons-material/Clear'
import DoneIcon from '@mui/icons-material/Done'
// import { MainButton } from '../../components/Buttons'
import { sportsimages } from '../../Constant'

function Fitness() {
  // return <>Hello Fitness</>
  return (
    <Box
    ...
    >
      ...
      >
        ...
        <Box textAlign="center" maxWidth="300px">
          ...
          <Typography fontSize="12px" fontWeight="300" sx={{ color: '#fff' }}>
            Discover Switzerland’s best ski resorts and plan the perfect holiday
          </Typography>
        </Box>
      </Box>
