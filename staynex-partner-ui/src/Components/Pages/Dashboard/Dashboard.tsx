...
const Dashboard = () => {
    ...
    const cardlist = [
        { label: 'Total Sales (USDT)', value: '700 000 000', }, { label: 'Total pass sold', value: '18', },
                ...
                <div className='dashboard_section'>
                    ...
                    <div className='statistics_card'>
                        ...
                        <Row className='mt-4 mt-md-5'>
                            <Col xs={6}>
                               <CommonButton onClick={() => setShow(true)} title="Create new" className="w-100" />
                            </Col>
                            <Col xs={6}>
                               <CommonButton title="View passes" className="border-btn w-100" />
                            </Col>
                        </Row>
                    </div>
                </div>
