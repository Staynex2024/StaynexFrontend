          ...
          >
            <Box display="flex" flexDirection="column" gap="30px">
              <Box display="flex" alignItems="center" gap="5px">
                ...
                <Typography fontWeight="500">
                  Create <span>additional revenue</span> streams through
                  Timeshare products
                </Typography>
              </Box>
              <Box display="flex" alignItems="center" gap="5px">
                ...
                <Typography fontWeight="500">
                  <span>Maximizing lower occupancy</span> and off peak days
                </Typography>
              </Box>
              <Box display="flex" alignItems="center" gap="5px">
                <img src="/Assets/staynexproperty/icon3.svg" alt="icon" />
                <Typography fontWeight="500">
                  <span>Increase</span> ADR and Revenue
                </Typography>
              </Box>
            </Box>
            ...
            <Box display="flex" gap="30px" flexDirection="column">
              <Box display="flex" alignItems="center" gap="5px">
                ...
                <Typography fontWeight="500">
                  <span>Maximize ancillary revenue</span> by monetizing
                  amenities
                </Typography>
              </Box>
              <Box display="flex" alignItems="center" gap="5px">
                ...
                <Typography fontWeight="500">
                  <span>Drive demand</span> and exposure through Global Partners
                </Typography>
              </Box>
              <Box display="flex" alignItems="center" gap="5px">
                <img src="/Assets/staynexproperty/icon6.svg" alt="icon" />
                <Typography fontWeight="500">
                  <span>Increase</span> in repeated bookings
                </Typography>
              </Box>
            </Box>
          </Box>
